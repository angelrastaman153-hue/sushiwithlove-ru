...
$items = $pdo->query(
    'SELECT id, category_id, name, price, weight_grams, pieces_count, image_url, description, flavor_description, fp_article_id, is_stop, sort_order, group_key, variant_label
